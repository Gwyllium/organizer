#include "testdiaryrecord_all.h"

TestDiaryRecord_all::TestDiaryRecord_all(QObject *parent) :
    QObject(parent)
{
}

void TestDiaryRecord_all::getName()
{
...
void TestDiaryRecord_all::getName_data()
{
...
void TestDiaryRecord_all::getText()
{
    QFETCH(QString, expected);
    QFETCH(QString, actual);
    QCOMPARE(expected, actual);
...
void TestDiaryRecord_all::getText_data()
{
    QTest::addColumn<QString>("expected");
    QTest::addColumn<QString>("actual");
...
void TestDiaryRecord_all::getDate()
{
...
void TestDiaryRecord_all::getDate_data()
{
...
void TestDiaryRecord_all::getTags()
{
//    QStringList actual;
