#include "testtask_all.h"

TestTask_all::TestTask_all(QObject *parent) :
    QObject(parent)
{
}

void TestTask_all::nameIsEmpty()
{
    QString name = "";
    try
    {
...
void TestTask_all::getName_data()
{
...
void TestTask_all::getStartDate() {
    QFETCH(QDate, expected);
    QFETCH(QDate, actual);
    QCOMPARE(expected, actual);
}

void TestTask_all::getStartDate_data()
{
...
void TestTask_all::getEndDate_data()
{
